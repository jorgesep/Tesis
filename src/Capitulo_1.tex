...
\subfigure[Evitar obstáculos]{\label{fig:Figure_A}\includegraphics[width=50mm]{img/ch1/MobileEyemaster}}
\subfigure[Reconocimiento de vehículos]{\label{fig:Figure_B}\includegraphics[width=50mm]{img/ch1/self-driving-cars}}
\subfigure[Reconocimiento de peatones]{\label{fig:Figure_C}\includegraphics[width=50mm]{img/ch1/crossing}}
\subfigure[Experimentación con vehículos autónomos \tiny{(Figure courtesy Google \copyright )}]{\label{fig:Figure_D}\includegraphics[width=50mm]{img/ch1/Google500KmilesLexus}}
\subfigure[Reconocimiento de caras \tiny{(http://www.netmechanic.co.za/ \copyright)}]{\label{fig:Figure_E}\includegraphics[width=50mm]{img/ch1/face_recognition_technology}}
